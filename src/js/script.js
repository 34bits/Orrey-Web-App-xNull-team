...
const earthSpecularCloudsTexture = textureLoader.load("/earth/clouds.jpg");
earthSpecularCloudsTexture.colorSpace = THREE.SRGBColorSpace;
earthSpecularCloudsTexture.anisotropy = 8;

const venusTexture = textureLoader.load("/venus/venus_surface.jpg");
venusTexture.colorSpace = THREE.SRGBColorSpace;
venusTexture.anisotropy = 8;

const neptuneTexture = textureLoader.load("/neptune/neptune.jpg");
neptuneTexture.colorSpace = THREE.SRGBColorSpace;
neptuneTexture.anisotropy = 8;

const uranusTexture = textureLoader.load("/uranus/uranus.jpg");
...
const mercuryTexture = textureLoader.load("/mercury/mercury.jpg");
mercuryTexture.colorSpace = THREE.SRGBColorSpace;
mercuryTexture.anisotropy = 8;

const marsTexture = textureLoader.load("/mars/mars.jpg");
marsTexture.colorSpace = THREE.SRGBColorSpace;
marsTexture.anisotropy = 8;

const jupiterTexture = textureLoader.load("/jupiter/jupiter.jpg");
...
const saturnTexture = textureLoader.load("/saturn/saturn.jpg");
...
const planetData = {
  ...
  uranus: {
    ...
    atmosphere: "Hydrogen, Helium, Methane",
    image: "/public/uranus/data/uranus.jpg",
    description:
      "Uranus is the seventh planet from the Sun and has the third-largest diameter in the solar system. It is a cold, windy world with a unique sideways rotation, making it one of the most unusual planets in the solar system.",
...
function onKeyDown(event) {
  ...
  if (index >= 0 && index < planets.length) {
    ...
    displayPlanetInfo(planets[currentPlanetIndex]);
    speakPlanetInfo();
  }
}
